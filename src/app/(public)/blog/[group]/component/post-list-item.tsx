...
export default function PostItem({
  ...
  return (
    <div className="group cursor-pointer flex flex-col items-center rounded-2xl  pb-5">
      <div className="w-full aspect-[16/9] rounded-md relative overflow-hidden border ml-auto ">
        {thumbnail_url && (
          <Image
      ...
      <div className="flex flex-col gap-2 py-5">
        <div className="flex gap-2">
          ...
          <div className="relative inline-flex items-center justify-center">
            ...
            {/* 실제 Badge 내용 */}
            <Badge variant={"secondary"} className="relative text-xs">
              New
            </Badge>
          </div>
        </div>
        <Link href={`/blog/${sub_group_name}/${post_id}`}>
          <p className="group-hover:text-amber-200 text-xl  leading-9 break-keep">
            {post_title}
          </p>
        </Link>
        ...
        <p className="text-xs text-muted-foreground/80 mt-1 flex gap-3">
